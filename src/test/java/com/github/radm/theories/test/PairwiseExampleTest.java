 ...
 * <a href="https://en.wikipedia.org/wiki/All-pairs_testing">wikipedia </a>) and
 * <a href="http://www.cornutum.org/tcases/docs/Tcases-Guide.htm#exampleFind">
 * tcases</a>.
 */
...
public class PairwiseExampleTest {
    ...
    @Constraint
    public static boolean matchConstraints(ChoiceType linesLongerThanPattern, ChoiceType matchingLines,
