...
public class SinglePairState {
   ...
   *
   * @param colOne the first column index
   * @param colTwo the second column index
   * @param numOptions the number of options per column
   */
   ...
   *
   * @param colOneValue the value for col one
   * @param colTwoValue the value for col two
   */
